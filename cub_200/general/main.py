...
def main_func(params_dir_path):
    for filename in os.listdir(params_dir_path):
        ...
        if filename.endswith('.json'):
            ...
            data_module = CUBDataModule(params['batch_size'], params['data_dir'],
            ...
            # initialize trainer
            tb_logger = TensorBoardLogger(params['logging_dir'], name=params[
                'logging_name'], log_graph=False)
            trainer = pl.Trainer(
                accelerator=params['accelerator'],
                max_epochs=params['max_epochs'],
                strategy=params['strategy'],
                callbacks=[checkpoint_callback, PrototypeProjectionCallback(params)],
...
if __name__ == '__main__':
    ...
    # directory_path = "/MNIST/params_linux"
