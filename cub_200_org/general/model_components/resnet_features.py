...
class ResNet_features(nn.Module):
    ...
    def _make_layer(self, block, planes, num_blocks, stride=1):
        ...
        for each_block in layers:
            ...
            layer_kernel_sizes.extend(block_kernel_sizes)
            layer_strides.extend(block_strides)
            layer_paddings.extend(block_paddings)

        self.kernel_sizes.append(layer_kernel_sizes)
        self.strides.append(layer_strides)
        self.paddings.append(layer_paddings)
