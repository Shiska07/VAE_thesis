...
class EncoderBlock(nn.Module):
    def __init__(self, input_channels=1, latent_channels=16, ksize=3):
        ...
        self.conv_mu = nn.Conv2d(32, latent_channels, kernel_size=ksize, stride=1, padding="valid")
        self.conv_logvar = nn.Conv2d(32, latent_channels, kernel_size=ksize, stride=1, padding="valid")
