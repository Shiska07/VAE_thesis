...
def get_average_losses(losses_list):
    ...
    for loss_dict in losses_list:
        ...
        cum_l1_loss += loss_dict["l1_loss"]
        cum_total_loss += loss_dict["total_loss"]
        cum_total_acc += loss_dict["acc"]


    avg_metric_dict = {"recon_loss": cum_rec_loss,
                     "kl_loss": cum_kl_loss,
                     "ce_loss": cum_ce_loss,
                     "clst_loss": cum_clst_loss,
                     "sep_loss": cum_sep_loss,
                     "l1_loss": cum_l1_loss,
                     "total_loss": cum_total_loss,
                     "acc": cum_total_acc}
